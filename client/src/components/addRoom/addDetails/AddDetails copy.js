import { FormControl, FormControlLabel, InputAdornment, InputLabel, MenuItem, Radio, RadioGroup, Select, Stack, TextField } from '@mui/material'
...
const AddDetails = () => {
    const {
        state:{
            details:{title, task, description, price, client, employee}, filteredUsers
        },
        dispatch,
    } = useValue()
