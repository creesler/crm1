...
const Main = ({setSelectedLink, link}) => {
  const {state:{rooms, users, currentUser}, dispatch} = useValue()
    useEffect(()=>{
  ...
  return (
    ...
    >
      <Paper elevation={3} sx={{p:3}}>
        <Typography variation='h4'>Total Users</Typography>
        <Box
        sx={{
          display:'flex',
          alignItems:'center',
      ...
      <Paper elevation={3} sx={{p:3}}>
        <Typography variation='h4'>Total Tasks</Typography>
        <Box
        sx={{
          display:'flex',
          alignItems:'center',
      ...
      <Paper elevation={3} sx={{p:2, gridColumn:3, gridRow:'1/4'}}>
        <Box>
          <Typography>Recenty Added Users</Typography>
          <List>
        ...
        <Box>
          <Typography>Recenty Added Tasks</Typography>
          <List>
