import { ChevronLeft, Construction, Dashboard, Inbox, KingBed, Logout, Mail, MarkChatUnread, NotificationsActive, PeopleAlt } from '@mui/icons-material';
  ...
  useCheckToken()
    ...
    const list = useMemo(()=>[
        ...isAdmin(currentUser) ? [
          ...
          {title:'Rooms', icon:<Construction/>, link:'rooms', component:<Rooms {...{setSelectedLink, link:'rooms'}}/>}, 
